...
function setImg(){
    return slider_img.setAttribute('src', "/media/works/kosmos/first_part/main_slideshow/pics/" + images[i])
}
...
function obiemSwitchToEnglish() {
    var english_obiem_appears = anime({
        targets:'.obiem-english',
        opacity: 1,
        duration:9000,
        autoplay:true,
    })   

    var disappear_obiem = anime({
        targets:'.obiem',
        opacity: 0,
        duration:9000,
        autoplay:true,
...
function obiemBackToRussian() {
    var disappear_english_obiem = anime({
        targets:'.obiem-english',
        opacity: 0,
        duration:9000,
...
function gaivanSwitchToEnglish() {
    var english_gaivan_appears = anime({
        targets:'.gaivan-english',
        opacity: 1,
        duration:9000,
        autoplay:true,
    })   

    var disappear_gaivan = anime({
        targets:'.gaivan',
        opacity: 0,
        duration:9000,
        autoplay:true,
...
function gaivanBackToRussian() {
    var disappear_english_gaivan = anime({
        targets:'.gaivan-english',
        opacity: 0,
        duration:9000,
...
function pialaSwitchToEnglish() {
    var english_piala_appears = anime({
        targets:'.piala-english',
        opacity: 1,
        duration:9000,
        autoplay:true,
    })   

    var disappear_piala = anime({
        targets:'.piala',
        opacity: 0,
        duration:9000,
        autoplay:true,
...
function pialaBackToRussian() {
    var disappear_english_piala = anime({
        targets:'.piala-english',
        opacity: 0,
        duration:9000,
...
function glazurSwitchToEnglish() {
    var english_glazur_appears = anime({
        targets:'.glazur-english',
        opacity: 1,
        duration:9000,
        autoplay:true,
    })   

    var disappear_glazur = anime({
        targets:'.glazur',
        opacity: 0,
        duration:9000,
        autoplay:true,
...
function glazurBackToRussian() {
    var disappear_english_glazur = anime({
        targets:'.glazur-english',
        opacity: 0,
        duration:9000,
        autoplay:true,
