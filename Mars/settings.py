...
MIDDLEWARE = [
    'whitenoise.middleware.WhiteNoiseMiddleware', #ВАЖНО ВСТАВИТЬ ВАЙТНОЙЗ ДО СЕКЬЮРИТИ
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Mars',
        'USER': 'aokvxzithtwkjw',
        'PASSWORD': '46216aa421194e49a541d94167ff5573a8092ea5e32413c19d73d1708bc97b7b',
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'glavnaya/static'),
)
